      ...
      <div className="mx-auto max-w-4xl">
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <h1 className="text-3xl font-semibold tracking-tight text-[#1e2226] md:text-4xl">
            HDB Valuation in Woodlands (Free Estimate Based on Recent Transactions)
          </h1>

          <p className="mt-4 text-base leading-7 text-[#4a4f55]">
            Looking to find out how much your HDB flat in Woodlands is worth?
            This page gives you an overview of Woodlands HDB prices based on recent
          ...
          <section className="mt-12">
            <h2 className="text-xl font-semibold text-[#1e2226]">
              Woodlands HDB Prices and Market Trends
            </h2>
            <p className="mt-4 text-base leading-7 text-[#4a4f55]">
              Woodlands is a well-established HDB estate in Singapore, with steady demand from both families and upgraders. Prices vary depending on flat type, floor level, proximity to MRT stations, and renovation condition.
            </p>
          </section>
            ...
            <div className="mt-6 space-y-4">
              <div>
                <h3 className="font-medium text-[#1e2226]">
                  How much are HDB flats in Woodlands worth?
                </h3>
